...
$(".main").onepage_scroll({
    ...
    beforeMove: function (b) {
        ...
        $("#mapstyle").html("@media only screen and (min-width: 64.063em){.viewing-page-7 .main section.page7 .map-pin, .fallback-scroll-6 .main section.page7 .map-pin { background: url(image/pinpoint.gif?p" + (new Date).getTime() + ") !important; background-repeat: no-repeat !important; }}")
    },
...
function verticalCenter() {
    $(".onepage-pagination a").each(function () {
        1 == $(this).attr("data-index") ? $(this).html('<span class="name">首页</span>') : $(this).html('<span class="name">' + $(".menus .main-nav [data-menu-index=" + $(this).attr("data-index") + "]").text() + "</span>")
    });
