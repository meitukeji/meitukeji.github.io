...
$(".main").onepage_scroll({
    ...
    beforeMove: function (b) {
        ...
        $("#mapstyle").html("@media only screen and (min-width: 64.063em){.viewing-page-7 .main section.page7 .map-pin, .fallback-scroll-6 .main section.page7 .map-pin { background: url(img/pinpoint.gif?p" + (new Date).getTime() + ") !important; background-repeat: no-repeat !important; }}")
    },
